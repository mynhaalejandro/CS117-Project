...
<!---End Header-->
	<section class="agfish">
		<div class="container-agfish">
			<section class="agfish" id="agfish-name">
				<h1>Agri-Fishery Arts Strand</h1>
			</section>
			<section class="agfish" id="agfish-des">
		...
		<div class="agfish" id="agfish-1">
			<article>
			<details ontoggle>
				<summary> <strong> What are the subjects in this strand?</strong> </summary>
					<p>At the Agri-Fishery Arts strand, you can familiarize yourself with the production industries of horticulture, animal production, crop production, rubber production, slaughtering operations, and pest management. You can also dive deep in the field of aquaculture and learn about fish production, fish wharf operation, and food processing.</p><br>
					<p>This curriculum aims to make sure that you are well-informed and well-prepared with the basic skills and knowledge just in case you choose to work in farms or fisheries. You will also undergo a Personal Entrepreneurial Competencies (PEC) assessment so you can enhance your business management skills.</p>
			</details>
			<br>
 			<details ontoggle>
				<summary> <strong> What can I do after SHS?</strong> </summary>
					<p>There are a lot of businesses you can start once you graduate in this track. You can open a fishpond, be a rice thresher, or begin a small scale food processing enterprise. However, this does not mean you can’t pursue college degrees anymore.</p><br>
					<p>You can still take up courses on agriculture, fisheries, and forestry. After college, you can get to careers such as development researcher, agriculturist, animal husbandry, or aquatic ecologist.</p>
			</details>
			</article>
		</div>
	</section>
