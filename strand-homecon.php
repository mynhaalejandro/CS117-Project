...
<head>
	...
	<title>Sinait National High School - Home Economics</title>
...
<!---End Header-->
	<section class="homecon">
		...
		<section class="homecon" id="homecon-name">
			<h1>Home Economics Strand</h1>
		</section>
		<section class="homecon" id="homecon-des">
			<p>The Home Economics track offers various specializations that can lead to livelihood projects at home. This strand aims to give you job-ready skills that can help you in finding the right employment.
			</p>
		</section>
		</div>

		<div class="homecon" id="homecon-1">
			<article>
			<details ontoggle>
				<summary> <strong> What are the subjects in this strand?</strong> </summary>
					<p>Subjects in the Home Economics can also lead to National certifications based on TESDA standards. You will be taking up courses on barbering, bartending, beauty care, bread and pastry, caregiving, cookery, dressmaking, food and beverage, housekeeping, tourism, handicrafts among others.</p>
			</details>
			<br>
 			<details ontoggle>
				<summary> <strong> What can I do after SHS?</strong> </summary>
					<p>There are so many careers that you can explore after taking this strand! You can have a future of becoming a baker, barista, makeup artist, barber, stylist, therapist, clerk, tailor, tour guide, or chambermaid. Various business set ups are also into this track like dress shop, beauty salon, coffee shop, bakery, snack bar, food cart, handicrafts among others.</p><br>
					<p>This strand can also prepare you to college degrees on Hospitality and Tourism Management, Nutrition, Food Technology, Culinary Arts, Business Education, or Interior Designing.</p>
			</details>
			</article>
		</div>
	</section>
